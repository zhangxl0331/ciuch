...
<?php if(!empty($user)):?>
	<div class="composer_header">
		...
		<div class="ar_r_t"><div class="ar_l_t"><div class="ar_r_b"><div class="ar_l_b"><img src="<!--{avatar($_SGLOBAL[supe_uid],middle)}-->" alt="<?=$user['username']?>" width="120" /></div></div></div></div>
		
		<div class="composer">
			<h3 class="index_name">
				<a href="space.php?uid=$space[uid]"<!--{eval g_color($space[groupid]);}-->><?=$user['username']?></a>
