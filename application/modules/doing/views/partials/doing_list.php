	...
	<?php foreach($list as $value):?>
		<li id="dl<?=$value['doid']?>">
			...
			<div class="doing">
				...
				<?php if($auth && $auth['uid']==$user['uid']):?> <a href="<?=site_url('doing/delete/'.$value['doid'])?>" id="doing_delete_<?=$value['doid']?>" onclick="ajaxmenu(event, this.id, 99999)" class="re gray">删除</a><?php endif;?>
				</div>
