...
<div class="h_status">
	...
	查看日志<span class="pipe">|</span><a href="{{ url:base }}blog/{{ space:uid }}/view/me">返回{{ helper:lang line="blog" }}列表</a>
</div>
...
<div{{if blog:related}} id="content"{{ endif }}>
	<div class="entry">
		...
		<div class="status">
			...
			<span id="comment_replynum">{{if blog:viewnum }}{{ blog:replynum }}{{ else }}0{{ endif }}</span> 个评论
		</div>
	</div>
